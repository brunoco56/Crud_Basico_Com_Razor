...
namespace ContSelf.Controllers
{
    public class AgendaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Agendamento,Desconto")] Agenda agenda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Agendamento,Desconto")] Agenda agenda)
        {
            if (id != agenda.Id)
            {
                return NotFound();
