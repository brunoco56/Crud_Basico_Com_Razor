...
namespace ContSelf.Controllers
{
    public class FuncionarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CodFuncionario,Nome,DataNascimento,Salario,Atividade")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CodFuncionario,Nome,DataNascimento,Salario,Atividade")] Funcionario funcionario)
        {
