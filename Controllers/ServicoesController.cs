...
namespace ContSelf.Controllers
{
    public class ServicoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Valor,Descricao")] Servico servico)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Valor,Descricao")] Servico servico)
        {
            if (id != servico.Id)
            {
                return NotFound();
